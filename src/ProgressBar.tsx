...
class ProgressBar extends Component<ProgressBarProps, ProgressBarState> {
  ...
  handleAudioDownloadProgressUpdate = (e: Event): void => {
    ...
    for (let i = 0; i < audio.buffered.length; i++) {
      ...
      downloadProgressArr.push({
        ...
        width: `${
          Math.round((100 / duration) * (bufferedEnd - bufferedStart)) || 0
        }%`,
      });
    }
  ...
  componentDidUpdate(): void {
    ...
    if (audio && !this.hasAddedAudioEventListener) {
      ...
      audio.addEventListener("progress", (e: Event) =>
      ...
      >
        <div
          className={`rhap_progress-bar ${
            showDownloadProgress ? "rhap_progress-bar-show-download" : ""
          }`}
        >
          <div
          ...
          />
          {showFilledProgress && <div className="rhap_progress-filled" />}
          {showDownloadProgress &&
